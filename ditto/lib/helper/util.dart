...
class Utils {
  ...
  static final double appBarHeight =
      AppBar().preferredSize.height; //app bar height
  static double statusBarHeight; //status bar height
  static double
      totalBodyHeight; //total screen height without appbar or status bar
  static double
      reducedBodyHeight; //body height with appbar and status bar reduced
  static double
      contentBodyHeight; //body height with appbar and status bar and bottom navigation bar reduced
